...
//var teenStudentsName = studentList.Where(s => s.Age > 12 && s.Age < 20)
...
//var studentiGrupisaniPoStandardu2 = studentList.Where(s => s.StandardId > 0)
...
var studentsWithStandard = standardList.Join(studentList,
    std => std.StandardId,
    stu => stu.StandardId,
    (std, stu) => new
    {
