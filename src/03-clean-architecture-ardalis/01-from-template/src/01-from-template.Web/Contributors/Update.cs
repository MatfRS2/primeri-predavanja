...
using _01_from_template.UseCases.Contributors.Update;
using _01_from_template.Web.Endpoints.ContributorEndpoints;
using Ardalis.Result;
using Ardalis.SharedKernel;
using FastEndpoints;
using MediatR;

namespace _01_from_template.Web.ContributorEndpoints;
/// <summary>
