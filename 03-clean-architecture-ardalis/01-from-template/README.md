...
To update the database use this command from the Web project folder (replace `_03_clean_architecture_ardalis` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../_03_clean_architecture_ardalis.Infrastructure/_03_clean_architecture_ardalis.Infrastructure.csproj -s _03_clean_architecture_ardalis.Web.csproj
```
